...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    title: "Chess",
    short: "Full rules, four AI tiers, modern board.",
    description:
      "Full chess against a built-in AI. Four difficulty tiers from random-move 'Pawn' to a 3-ply minimax 'Queen' with positional sense. Modern board with click-to-move, legal-move highlights, captured pieces panel, full move history in algebraic notation, undo, side swap, resign. Full rule support: castling, en passant, pawn promotion, threefold repetition, 50-move and insufficient material draws.",
    categories: ["strategy", "puzzle"],
    tags: ["classic", "board", "single-player"],
  ...
  },
  {
    ...
    title: "GeoGuessr",
    short: "Where in the world is this landmark?",
    description:
      "30 famous landmarks worldwide. Each round shows a photo — you click on the world map to guess where it is. Closer guess, more points (5,000 max per round). Five rounds, 25,000 maximum, mix of easy / medium / hard locations. Photos pulled from Wikipedia; map by OpenStreetMap.",
    categories: ["puzzle", "adventure"],
    tags: ["geography", "single-player", "highscore"],
  ...
  },
  {
    ...
    title: "Agma",
    short: "Cell-eater chaos — split, eject, dodge viruses.",
    description:
      "Faster, denser take on the cell-eater genre. Same eat-anything-smaller core as Agar, but smaller arena, more bots, and three new mechanics: Space splits a big cell forward to catch a fleeing prey, W ejects mass forward as a pellet, and stationary green spiky viruses shatter any cell bigger than them on contact. Multi-cell management and a 10s merge cooldown make every split a real commitment.",
    categories: ["action", "arcade"],
    tags: ["arcade", "endless", "ai", "highscore"],
    gradient: "linear-gradient(135deg, #ef4444 0%, #facc15 100%)",
    glyph: "⚡",
    source: "custom",
    controls: ["Mouse", "Space", "W"],
    players: "single",
    isNew: true,
    rating: 4.2,
    plays: 22_100,
